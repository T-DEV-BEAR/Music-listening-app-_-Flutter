...
import 'package:spotify/presentation/home/pages/library_liked/library_search_screen.dart';
import 'package:spotify/presentation/home/pages/library_liked/like_song_control.dart';
...
class LikeSongsScreen extends StatefulWidget {
  ...
  @override
  State<LikeSongsScreen> createState() => _LikeSongsScreenState();
}

class _LikeSongsScreenState extends State<LikeSongsScreen> {
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                // Ô chứa "Tìm trong mục Bài hát đã tải..."
                                Expanded(
                                  flex:
                                      3, // Cho ô này chiếm nhiều không gian hơn
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 16, vertical: 10),
                                ...
                                // Ô chứa "Sắp xếp" với chiều rộng nhỏ hơn
                                const Flexible(
                                  flex: 1,
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            final favoriteSongsState =
                                context.read<FavoriteSongsCubit>().state;

                            // Use the local currentSong variable here
                            final SongEntity? currentPlayingSong = currentSong;

                            if (favoriteSongsState is FavoriteSongsLoaded) {
                              ...
                              if (favoriteSongs.isNotEmpty) {
                                if (currentPlayingSong != null &&
                                    favoriteSongs
                                        .contains(currentPlayingSong)) {
                                  int currentIndex =
                                      favoriteSongs.indexOf(currentPlayingSong);
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                  ...
                                  onSongSelected(favoriteSongs[0]);
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => SongPlayerPage(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          if (favoriteSongsState is FavoriteSongsLoaded) {
                            ...
                            if (favoriteSongs.isNotEmpty) {
                              if (currentPlayingSong != null &&
                                  favoriteSongs.contains(currentPlayingSong)) {
                                int currentIndex =
                                    favoriteSongs.indexOf(currentPlayingSong);
                                Navigator.push(
                                  context,
  ...
  Widget _songTile(
      {required SongEntity song, required List<SongEntity> favoriteSongs}) {
    bool isCurrentSong = song == currentSong;

    return GestureDetector(
      onTap: () {
        if (favoriteSongs.isNotEmpty && favoriteSongs.contains(song)) {
          onSongSelected(song);
          Navigator.push(
            context,
            MaterialPageRoute(
      ...
      return Wrap(
        children: [
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context);
              context.read<FavoriteSongsCubit>().sortSongs(SortOption.recent);
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context);
              context.read<FavoriteSongsCubit>().sortSongs(SortOption.recentlyAdded);
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context);
              context.read<FavoriteSongsCubit>().sortSongs(SortOption.alphabetical);
            },
          ),
        ],
      );
