...
class NewEpisodedSearchScreen extends StatefulWidget {
  const NewEpisodedSearchScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _NewEpisodedSearchScreenState createState() => _NewEpisodedSearchScreenState();
}

class _NewEpisodedSearchScreenState extends State<NewEpisodedSearchScreen> {
  String _searchQuery = '';
                  ...
                  child: BlocBuilder<NewsSongsCubit, NewsSongsState>(
                    builder: (context, state) {
                      if (state is NewsSongsLoading) {
                        ...
                        final filteredSongs = _searchByNameSongsAndArtists(state.songs, _searchQuery);
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        onChanged: (value) {
                          ...
                          final searchScreenState = context.findAncestorStateOfType<_NewEpisodedSearchScreenState>();
