...
class NewsSongs extends StatelessWidget {
  final Function(SongEntity) onSongSelected; // Thêm callback onSongSelected

  const NewsSongs({super.key, required this.onSongSelected});
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          onTap: () {
            onSongSelected(songs[index]); // Gọi callback khi chọn bài hát
            Navigator.push(
              context,
              MaterialPageRoute(
